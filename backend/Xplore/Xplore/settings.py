...
LDAP_ADMIN_ID = os.getenv('LDAP_ADMIN_ID', 'uid=admin,ou=system')
LDAP_ADMIN_PASSWD = os.getenv('LDAP_ADMIN_PASSWORD')

# OTP settings
OTP_DURATION_MINUTES = int(os.getenv('OTP_DURATION_MINUTES', 5))

# Email templates
BODY_EMAIL_VERIFICATION_OTP = """
Hello {}, Your OTP for Predict Xplore is {}.
